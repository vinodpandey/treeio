...
var Dajaxice = {
    ...
    get_more: function(callback_function, argv, custom_settings){
        return Dajaxice.call('treeio.news.get_more', 'POST', callback_function, argv, custom_settings);
    }
    ...
    easy_invite: function(callback_function, argv, custom_settings){
        return Dajaxice.call('treeio.account.easy_invite', 'POST', callback_function, argv, custom_settings);
    },

    attachment_delete: function(callback_function, argv, custom_settings){
        return Dajaxice.call('treeio.account.attachment_delete', 'POST', callback_function, argv, custom_settings);
    },

    comments_likes: function(callback_function, argv, custom_settings){
        return Dajaxice.call('treeio.account.comments_likes', 'POST', callback_function, argv, custom_settings);
    },

    attachment: function(callback_function, argv, custom_settings){
        return Dajaxice.call('treeio.account.attachment', 'POST', callback_function, argv, custom_settings);
    },

    tags: function(callback_function, argv, custom_settings){
        return Dajaxice.call('treeio.account.tags', 'POST', callback_function, argv, custom_settings);
    }
    ...
    gantt: function(callback_function, argv, custom_settings){
        return Dajaxice.call('treeio.projects.gantt', 'POST', callback_function, argv, custom_settings);
    }
